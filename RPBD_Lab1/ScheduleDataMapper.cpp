...
void ScheduleDataMapper::show() {
    ...
    retcode = SQLExecDirect(hstmt,
        (SQLWCHAR*)L"select id, auditory, group_, week, day, time from schedule;", SQL_NTS);
    ...
    retcode = SQLBindCol(hstmt, 3, SQL_C_CHAR, group, sizeof(group), NULL);
    retcode = SQLBindCol(hstmt, 4, SQL_C_CHAR, day, sizeof(day), NULL);
    retcode = SQLBindCol(hstmt, 5, SQL_C_CHAR, time, sizeof(time), NULL);
